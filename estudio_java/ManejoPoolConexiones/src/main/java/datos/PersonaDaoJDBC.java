...
import static datos.ConexionTest.*;
...
public class PersonaDaoJDBC implements IPersonaDao {
    ...
    public List<PersonaDTO> select() throws SQLException {
        ...
        // PreparedStatement es mas combeniente para trabajar con queris que Statement, osea es mas eficiente
        ResultSet rs = null;
    ...
    public int insert(PersonaDTO persona) throws SQLException {
        ...
        try {
            ...
            System.out.println("Numeros de registros afectados: " + registros);
        } finally {
    ...
    public int delete(PersonaDTO persona) throws SQLException {
        ...
        try {
            ...
            registros = stmt.executeUpdate();
            System.out.println("Numeros de registros eliminados: " + registros);
        } finally {
